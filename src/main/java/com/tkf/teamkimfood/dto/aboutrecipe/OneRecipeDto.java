...
public class OneRecipeDto {
    ...
    //1개 조회용
    @QueryProjection
    public OneRecipeDto(Long id, String title, String content, int viewCount, LocalDateTime writeDate, LocalDateTime correctionDate, String imgUrl, String nickName, String ingredients, String dosage, String situation, String foodStuff, String foodNationType) {
        this.id = id;
        this.title = title;
